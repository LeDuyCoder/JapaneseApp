      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 50,),
            Text("Chọn ngôn ngữ chính của bạn", style: TextStyle(color: AppColors.textSecond.withOpacity(1), fontSize: 30, fontFamily: "Itim", height: 0.5),),
            SizedBox(height: 30,),
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 20),
              child: Text("Chọn ngôn ngữ bạn muốn sử dụng làm ngôn ngữ chính trong ứng dụng. Bạn có thể thay đổi thiết lập này sau trong phần cài đặt.", textAlign: TextAlign.center, style: TextStyle(color: AppColors.textSecond.withOpacity(0.6), fontSize: 20, fontFamily: "Itim", height: 1),),
            ),
